...
####################################################################################################
# About module file
_MODULE_FILE_NAME = "viewportDisplayModeSwitcher.mod"
_MODULE_NAME = "viewportDisplayModeSwitcher"
_MODULE_VERSION = "1.0.0"
_SCRIPTS_DIR_NAME = "src"

# About shelf button
_COMMAND = """import maya_viewport_display_mode_switcher as scr<COMMAND_NEW_LINE>reload(scr)<COMMAND_NEW_LINE>scr.execute()<COMMAND_NEW_LINE>"""
